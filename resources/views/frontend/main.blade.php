...
<head>
  ...
  <!-- Flyer Skins. Choose a skin from the css/skins
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>Flyer</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Hungdv</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="/">My Company</a>.</strong> All rights
    reserved.
  </footer>
...
<!-- Flyer dashboard demo (This is only for demo purposes) -->
{{-- <script src="backend/dist/js/pages/dashboard.js"></script> --}}
<!-- Flyer for demo purposes -->
